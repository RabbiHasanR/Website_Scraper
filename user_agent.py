...
''''
default user_agent for random use
'''
...
def user_agent():
    ...
    user_agents = (
        ...
        "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_8; en-US) AppleWebKit/532.2 (KHTML, like Gecko) "
        "Chrome/4.0.221.8 Safari/532.2",
...
def google_user_agent():
    """return random google user agent """
